...
<html>
  <head>
    ...
    <link href="{{ asset('css/OpsAdmin/adminpanelstyle.css') }}" rel="stylesheet" type="text/css" />
    <!-- Font Awesome Icons -->
...
<meta name="csrf_token" content="{{ csrf_token() }}">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown tasks-menu">
                ...
                <!-- Menu Toggle Button -->
                <a href="{{URL::route('logout')}}"><span>Logout</span></a>
              </li>
              <!-- User Account Menu -->
    ...
    <!--      <ol class="breadcrumb">
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2015.<a href="javascript:void(0)"> ourperfectstart.com </a>&nbsp;&nbsp;</strong> All rights reserved.
      </footer>
