...
$imgsets = array(
 ...
 'maxwidth' => 1920,          // maximum allowed width, in pixels
 'maxheight' => 1080,         // maximum allowed height, in pixels
...
$filenames  = array();
$response   = array();
foreach(glob($_SERVER['DOCUMENT_ROOT']."/images/*.{jpg,png,gif}",GLOB_BRACE) as $filename)
{
...
foreach($filenames as $filename)
{
       ...
       array_push($response,array('image'=>$filename));
       //$response   =  array('image'=>$filename);
}
$filepath  =  $_SERVER['DOCUMENT_ROOT'] .'/images/images.json';
$fp = fopen($filepath, 'w+');
